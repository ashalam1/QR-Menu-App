...
const FoodCard = ({ image, name, price, onAddToCart }) => {
  ...
  const handleAddToCart = () => {
    onAddToCart({ image, name, price, quantity }); // Pass item details including quantity
  ...
  return (
    <div className="border rounded-lg shadow-md p-4 max-w-xs">
      ...
      <button 
        ...
        className="bg-yellow-500 text-black w-full px-3 py-1 rounded-md mt-4" // Full width and margin top
      >
